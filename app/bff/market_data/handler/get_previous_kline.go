...
func (h *getPreviousKlineHandler) Handle(c *gin.Context) {
	...
	previousKline, err := h.service.GetPreviousKline(c.Request.Context(), req.ToDomain())
	if err != nil {
